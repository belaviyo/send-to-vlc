...
chrome.runtime.sendNativeMessage('com.add0n.native_client', {
  ...
  if (response) {
    window.alert(`You've already installed the native client.
---
If you still get this page when you try to send a media URL to the external media player, most likely the path of the media player is not set correctly in the options page.

If the extension is sending links to the media player and you still get this page, go to the options page and uncheck open the setup page.`);
  }
});
